  ...
  return (
    ...
    <div className="bg-[#4DA1A9] p-5 flex flex-col items-center">
      ...
      <div className="flex  pb-8 mt-[40px] ">
        <div className="cards w-[150px] flex flex-col justify-centre items-center gap-1 py-5  px-5 rounded-[10px] text-white  ">
    ...
    <div className="flex pb-8  mt-[40px] ">
      <div className="cards-white w-[150px] flex flex-col justify-centre items-center gap-1 py-5  px-5 rounded-[10px] text-black  ">
